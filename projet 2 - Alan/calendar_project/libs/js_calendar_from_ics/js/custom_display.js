...
ics_sources = [
    {url:'../../src/php/get_ics_file_contents.php',event_properties: {color: 'Black'}}
]
...
$(document).ready(function() {
	...
	editable: false,
        ...
        eventRender: function(event, element, view) {
            ...
            let newdesc = event.description.substring(0,desc.length-30);
	  if(view.name == "listMonth" || view.name == "listWeek") {
        ...
        element.qtip.onclick = function(){window.open()}; 
